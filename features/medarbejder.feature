...
Feature: Adding a developer to the system
  ...
  Actors: Developer
  Scenario: Developer creates a non-existent employee
  ...
  Scenario: Developer creates an employee with more than 4 initials
  ...
  Scenario: Developer creates an existing employee
  ...
  Scenario: Developer creates an employee with no initials
