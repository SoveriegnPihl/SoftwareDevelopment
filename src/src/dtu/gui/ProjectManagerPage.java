...
public class ProjectManagerPage {
    ...
    public void initialize() {
        ...
        viewAvailableDevBtn.addActionListener(e -> {
            new OptionPane("View available developers");
        });
    ...
    public void createAssignPM() {
        ...
        b1.addActionListener(e -> {
            ...
            SoftwareHuset.assignPM((String) developerCombo.getSelectedItem(), Integer.parseInt((String) Objects.requireNonNull(projectCombo.getSelectedItem())));
    ...
    public void createAddDev() {
        ...
        b1.addActionListener(e -> {
            ...
            Project project = SoftwareHuset.projects.get(Integer.parseInt((String) Objects.requireNonNull(projectList.getSelectedItem())));
