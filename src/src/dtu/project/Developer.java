...
public class Developer {
    ...
    public void setToProjectManager() {
    ...
    public void setHolidayDates(String[] dateInterval) {
        if (dateInterval[1].equals("noOcc")) {
            ...
            occupiedFromThisDate = new GregorianCalendar(Integer.parseInt(dateInterval[1]), Integer.parseInt(dateInterval[2]), Integer.parseInt(dateInterval[3]));

            occupiedUntilThisDate = new GregorianCalendar(Integer.parseInt(dateInterval[4]), Integer.parseInt(dateInterval[5]), Integer.parseInt(dateInterval[6]));
    ...
    public void setSickDates(String[] dateInterval) {
        if (dateInterval[2].equals("noSick")) {
            ...
            if (hasOccupation) {
                sickFromThisDate = new GregorianCalendar(Integer.parseInt(dateInterval[7]), Integer.parseInt(dateInterval[8]), Integer.parseInt(dateInterval[9]));

                sickUntilThisDate = new GregorianCalendar(Integer.parseInt(dateInterval[10]), Integer.parseInt(dateInterval[11]), Integer.parseInt(dateInterval[12]));
            } else {
                sickFromThisDate = new GregorianCalendar(Integer.parseInt(dateInterval[2]), Integer.parseInt(dateInterval[3]), Integer.parseInt(dateInterval[4]));

                sickUntilThisDate = new GregorianCalendar(Integer.parseInt(dateInterval[5]), Integer.parseInt(dateInterval[6]), Integer.parseInt(dateInterval[7]));
            }
