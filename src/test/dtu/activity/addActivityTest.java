...
public class addActivityTest {
    ...
    public void there_is_a_project_named(String name)
        // Write code here that turns the phrase above into concrete actions
    }

    @When("they need a new activity named {string} with expected work hours {int} ")
    public void a_new_activity_with_name_and_with_expected_work_hours(String name, Integer expHours)
        // Write code here that turns the phrase above into concrete actions
    }

    @And("There is a activity with name {String}")
    public void there_is_an_activity_with_name_and_expected_work_hours(String name, Integer expHours)
        // Write code here that turns the phrase above into concrete actions
    }
